...
export default function ContractLayout({ children, currentPageName }) {
      ...
      <div className="min-h-screen bg-slate-50 flex">
        ...
        <aside className={cn(
          ...
          <div className="h-16 flex items-center justify-between px-4 border-b border-[#62997f]/20">
            {!collapsed && (
              <div className="text-sm font-bold text-[#355340]">Contratos</div>
            )}
            {collapsed && (
              <div className="text-xs font-bold text-[#355340]">CT</div>
            )}
            <Button
              variant="ghost"
              size="icon"
              ...
              {!collapsed && (
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[#355340]/60 truncate">
                    {user?.role === "admin" ? "Administrador" : user?.role === "closer" ? "Closer" : user?.role}
                  </p>
                </div>
              )}
              {!collapsed && (
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="lg:hidden h-14 bg-white border-b border-slate-200 flex items-center px-4 gap-3">
            ...
            <span className="text-sm font-bold text-[#355340] flex-1">Contratos</span>
            <NotificationCenter />
          </header>
